...
// 	static constexpr char monster_imgs_root_path[static_cast<int>(EnemyType::ENEMYTYPE_MAX)][40] = {
// 		"./assets/image/enemy/ghost",
// 	};
...
//  */
// Enemy *Enemy::create_enemy(EnemyType type, const vector<Point> &path) {
// 	switch(type) {
// 		case EnemyType::GHOST: {
// 			return new EnemyGhost{path};
// 		}
...
// // Enemy::Enemy(const vector<Point> &path, EnemyType type) {
